...
export const publishedProvider: Provider = {
...
export const publishedVenue: Venue = {
  id: "venue-nutty-lab",
...
export const publishedProgram: CampProgram = {
...
export const publishedSession: CampSession = {
